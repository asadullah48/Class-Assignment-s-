...
const page = () => {
  return (
    <div className="grid grid-cols-5 grid-rows-5 md:grid-rows-4 h-screen gap-2 p-2">
      ...
      <div className="flex justify-center items-center bg-green-400 col-span-5 md:col-span-2">Content2</div>
      <div className="flex justify-center items-center bg-red-400 col-span-5 md:col-span-2">Content3</div>
      <div className="flex justify-center items-center bg-orange-400 col-span-5">Footer</div>
    </div>
  );
};
